...
def parse_args():
    ...
    parser.add_argument('--model_root', type=str, default='/workspace/models/')
    parser.add_argument('--imgroot', type=str, default='/workspace/images/')
    parser.add_argument('--metaroot', type=str, default='/workspace/metadata/')
    parser.add_argument('--split', type=str, default='dev_seen_2020')
