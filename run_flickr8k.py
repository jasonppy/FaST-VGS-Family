...
# old_weights_fn = "/data1/scratch/exp_pyp/TransDAVEnet/plan_b/0_01_1_flickr8k_correct/best_bundle.pth"
...
# torch.save(new_sd, "/data1/scratch/exp_pyp/fast-vgs-and-friends/fast-vgs-flickr8k/best_bundle.pth", _use_new_zipfile_serialization=False)
